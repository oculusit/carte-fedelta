...
<div class="container">
  ...
  <div class="card">
    ...
    <p style="font-size:13px;color:#666;margin-bottom:12px">I loghi verranno automaticamente compressi in WebP (max 200×200 px) per occupare poco spazio e caricare velocemente.</p>
...
<div class="modal-overlay" id="cropModal">
  <div class="modal">
    ...
    <div class="modal-footer">
      <span class="info">Zoom con rotellina · trascina per ritagliare · formato quadrato 200×200</span>
